              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-3">
                      <span
                        className={`text-xs font-medium tabular-nums ${isOver ? "text-destructive" : isWarning ? "text-warning" : "text-success"}`}
                      >
