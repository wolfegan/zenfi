  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
            ...
            <DialogContent className="sm:max-w-[400px] rounded-2xl">
              ...
              <div className="space-y-4 py-2">
                ...
                <label className="flex items-center gap-2.5 cursor-pointer group">
                  ...
                  >
                    <div
                      className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-200 ${form.isFixed ? "translate-x-4" : ""}`}
                    />
                  </div>
                  <span className="text-xs text-muted-foreground">
                    Gasto Fixo (ex: aluguel, assinaturas)
                  </span>
                </label>
              </div>
        ...
        {/* Expense categories */}
        <div>
          <h2 className="text-xs font-semibold text-muted-foreground mb-3 tracking-wider uppercase">
            Despesas
          </h2>
        ...
        <AlertDialogContent className="sm:max-w-[340px] rounded-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-xs">
              Esta ação não pode ser desfeita. Todas as transações e orçamentos
