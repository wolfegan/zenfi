          ...
          >
            ...
            <div className="p-5 rounded-sm border bg-card">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className={`text-lg font-light tabular-nums ${summaryData.returnPercentage >= 0 ? "text-success" : "text-destructive"}`}
                >
                  {summaryData.returnPercentage >= 0 ? "+" : ""}
                  {summaryData.returnPercentage.toFixed(1)}%
                </span>
              </div>
            </div>
          </motion.div>
