...
export default function Reports() {
  ...
  const { data: realSummary } = useMonthlySummary(
  ...
  const annualExpenses = evolution.reduce(
    (s: number, e: any) => s + e.expenses,
    0,
  );
  const annualBalance = annualIncome - annualExpenses;
  const savingsRate =
    annualIncome > 0 ? (annualBalance / annualIncome) * 100 : 0;
        ...
        >
          <div className="p-5 rounded-sm border bg-card">
            ...
            <p className="text-xl font-light tabular-nums">
              {annualIncome.toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
            </p>
          ...
          <div className="p-5 rounded-sm border bg-card">
            ...
            <p className="text-xl font-light tabular-nums">
              {annualExpenses.toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
            </p>
          ...
          <div className="p-5 rounded-sm border bg-card">
            ...
            <p
              className={`text-xl font-light tabular-nums ${annualBalance >= 0 ? "text-success" : "text-destructive"}`}
            >
              {annualBalance.toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
            </p>
          ...
          <div className="p-5 rounded-sm border bg-card">
            ...
            <p
              className={`text-xl font-light tabular-nums ${savingsRate >= 0 ? "text-success" : "text-destructive"}`}
            >
